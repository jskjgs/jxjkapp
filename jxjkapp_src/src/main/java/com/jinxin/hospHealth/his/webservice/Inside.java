...
public class Inside  implements java.io.Serializable {
    ...
    /**
     * Gets the reData value for this Inside.
     *
     * @return reData
     */
    ...
    /**
     * Sets the reData value for this Inside.
     *
     * @param reData
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof Inside)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Inside.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">Inside"));
