...
public class OutPatient  implements java.io.Serializable {
    ...
    /**
     * Gets the reData value for this OutPatient.
     *
     * @return reData
     */
    ...
    /**
     * Sets the reData value for this OutPatient.
     *
     * @param reData
     */
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(OutPatient.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">OutPatient"));
