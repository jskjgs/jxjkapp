...
public class UserManager  implements java.io.Serializable {
    ...
    /**
     * Gets the reData value for this UserManager.
     *
     * @return reData
     */
    ...
    /**
     * Sets the reData value for this UserManager.
     *
     * @param reData
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof UserManager)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UserManager.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">UserManager"));
