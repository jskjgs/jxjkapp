...
public class PhysicalExamination  implements java.io.Serializable {
    ...
    /**
     * Gets the reData value for this PhysicalExamination.
     *
     * @return reData
     */
    ...
    /**
     * Sets the reData value for this PhysicalExamination.
     *
     * @param reData
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof PhysicalExamination)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PhysicalExamination.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">PhysicalExamination"));
