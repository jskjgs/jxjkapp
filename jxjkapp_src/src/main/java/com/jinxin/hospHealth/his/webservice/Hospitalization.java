...
public class Hospitalization  implements java.io.Serializable {
    ...
    /**
     * Gets the reData value for this Hospitalization.
     *
     * @return reData
     */
    ...
    /**
     * Sets the reData value for this Hospitalization.
     *
     * @param reData
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof Hospitalization)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Hospitalization.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">Hospitalization"));
